...
export class ServiceSupplyDto {
  @ApiProperty({ example: '60d5ec49c6d48227b409748e', description: 'ID del producto (insumo)' })
...
export class CreateServiceDto {
  @ApiProperty({ example: '1er Mantenimiento', description: 'Nombre del servicio' })
  @IsString({ message: i18nValidationMessage('validation.isString') })
  @IsNotEmpty({ message: i18nValidationMessage('validation.isNotEmpty') })
  name: string;

  @ApiPropertyOptional({ example: 'Mantenimiento preventivo básico.', description: 'Descripción breve' })
  @IsString({ message: i18nValidationMessage('validation.isString') })
  @IsOptional()
  description?: string;
  ...
  @ApiPropertyOptional({ type: [ServiceSupplyDto], description: 'Insumos requeridos' })
