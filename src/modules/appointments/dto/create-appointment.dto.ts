...
export class AppointmentVehicleDto {
  ...
  @ApiProperty({
    example: '1234',
    description: 'Últimos 4 dígitos del número de serie',
  })
  @IsString({ message: i18nValidationMessage('validation.isString') })
  @IsNotEmpty({ message: i18nValidationMessage('validation.isNotEmpty') })
...
export class CreateAppointmentDto {
  ...
  @ApiPropertyOptional({
    example: 'El cliente prefiere aceite sintético',
  ...
  @ApiPropertyOptional({
    ...
    description: 'Notas tomadas al recibir el vehículo',
  })
  @IsString({ message: i18nValidationMessage('validation.isString') })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 15,
    description: 'Duración estimada en minutos (default: 15)',
  })
  @IsNumber({}, { message: i18nValidationMessage('validation.isNumber') })
