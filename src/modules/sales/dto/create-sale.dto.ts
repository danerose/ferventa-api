...
export class SaleItemDto {
  ...
  @ApiPropertyOptional({
    example: '60d5ec49c6d48227b409749a',
    description: 'ID del servicio predefinido',
  })
  @IsMongoId({ message: i18nValidationMessage('validation.isMongoId') })
  @IsOptional()
  serviceId?: string;
...
export class CreateSaleDto {
  @ApiPropertyOptional({
    ...
    description: 'ID de la cotización origen si aplica',
  })
  @IsMongoId({ message: i18nValidationMessage('validation.isMongoId') })
  @IsOptional()
  quoteId?: string;
  ...
  @ApiPropertyOptional({
    ...
    description: 'ID del cliente (Requerido si no hay cotización)',
  })
  @IsMongoId({ message: i18nValidationMessage('validation.isMongoId') })
  @IsOptional()
  customerId?: string;
  ...
  @ApiPropertyOptional({
    type: [SaleItemDto],
    description: 'Artículos vendidos (Requerido si no hay cotización)',
  })
  ...
  @ApiPropertyOptional({
    example: 'MP-POINT-123456',
    description: 'Referencia de cobro / terminal',
  })
  @IsString({ message: i18nValidationMessage('validation.isString') })
  @IsOptional()
