...
export class CreateMaintenanceDto {
  ...
  @ApiPropertyOptional({
    example: 800.0,
    description: 'Costo inicial de mano de obra estimado',
  })
  ...
  @ApiPropertyOptional({
    example: 'Diagnóstico por ruido en balatas delanteras',
  ...
  @ApiPropertyOptional({
    example: '60d5ec49c6d48227b409748d',
    description:
      'ID de la cita agendada que origina este mantenimiento (opcional para walk-ins)',
  })
  @IsMongoId({ message: i18nValidationMessage('validation.isMongoId') })
  @IsOptional()
