...
export class ReportsController {
  ...
  @ApiOperation({
    summary:
      'Obtener resumen financiero de ventas por rango de fechas (Solo Admin)',
  })
  @ApiQuery({
    name: 'startDate',
    required: true,
  ...
  @ApiOperation({
    summary:
      'Obtener métricas de tiempos, promedios de estancia y vehículos pendientes de recolección',
  })
