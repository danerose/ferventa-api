...
export class CreateProductDto {
  ...
  @ApiProperty({
    example: 'Balatas Delanteras de Cerámica',
  ...
  @ApiPropertyOptional({
    example: 'Balatas de alta durabilidad para sistemas de frenado',
  ...
  @ApiPropertyOptional({
    example: 25,
    description: 'Stock inicial en inventario',
  })
  @IsNumber({}, { message: i18nValidationMessage('validation.isNumber') })
  @Min(0, { message: i18nValidationMessage('validation.min') })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 'piece',
    description: 'Unidad de medida (ej. piece, kit, liter)',
  })
  @IsString({ message: i18nValidationMessage('validation.isString') })
  @IsOptional()
  unit?: string;
  ...
  @ApiPropertyOptional({
    example: ['Nissan Versa 2015-2020', 'Nissan March 2012-2018'],
    description: 'Modelos de autos compatibles',
  })
  @IsArray({ message: i18nValidationMessage('validation.isArray') })
  @IsString({
    each: true,
