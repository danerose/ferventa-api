...
export class AuthService {
  ...
  async signup(signupDto: SignupDto): Promise<UserDocument> {
    ...
    if (!sellerRole) {
      ...
      throw new NotFoundException(
        i18n
          ? i18n.t('common.errors.defaultRoleNotConfigured')
          : 'El rol de vendedor por defecto no está configurado',
      );
    }
  ...
  async login(loginDto: LoginDto, ip: string, userAgent: string) {
    ...
    if (!identifier) {
      ...
      throw new BadRequestException(
        i18n
          ...
          : 'Se requiere un nombre de usuario o correo electrónico',
      );
    }
    ...
    const refreshExpiresInString = this.configService.get<string>(
    ...
    if (!user) {
      ...
      throw new UnauthorizedException(
        i18n
          ? i18n.t('common.errors.invalidCredentials')
          : 'El usuario/correo o la contraseña son incorrectos',
      );
    }
    ...
    if (!user.isActive) {
      ...
      throw new UnauthorizedException(
        i18n
          ? i18n.t('common.errors.inactiveUser')
  ...
  async refresh(refreshToken: string) {
    try {
      ...
      throw new UnauthorizedException(
        i18n
          ? i18n.t('common.errors.invalidRefreshToken')
