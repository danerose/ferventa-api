...
export class MigrationController {
  ...
  @ApiOperation({
    summary:
      'Migra todos los registros antiguos para asignarles la sucursal por defecto. Asigna esta sucursal a los usuarios administradores. Es idempotente.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    summary:
      'Migra los usuarios existentes que no tengan un nombre de usuario asignado. Genera un usuario único basado en su nombre.',
  })
  @ApiResponse({
    status: 200,
