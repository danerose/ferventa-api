...
import { Vehicle, VehicleDocument } from '../src/modules/vehicles/schemas/vehicle.schema';
import { Appointment, AppointmentDocument } from '../src/modules/appointments/schemas/appointment.schema';
import { WorkshopHoliday, WorkshopHolidayDocument } from '../src/modules/appointments/schemas/workshop-holiday.schema';
import { WorkshopSchedule, WorkshopScheduleDocument } from '../src/modules/appointments/schemas/workshop-schedule.schema';
import { Brand, BrandDocument } from '../src/modules/inventory/schemas/brand.schema';
import { Category, CategoryDocument } from '../src/modules/inventory/schemas/category.schema';
import { Provider, ProviderDocument } from '../src/modules/inventory/schemas/provider.schema';
import { Product, ProductDocument } from '../src/modules/inventory/schemas/product.schema';
import { StockMovement, StockMovementDocument } from '../src/modules/inventory/schemas/stock-movement.schema';
import { Maintenance, MaintenanceDocument } from '../src/modules/maintenance/schemas/maintenance.schema';
import { Quote, QuoteDocument } from '../src/modules/quotes/schemas/quote.schema';
import { Sale, SaleDocument } from '../src/modules/sales/schemas/sale.schema';
